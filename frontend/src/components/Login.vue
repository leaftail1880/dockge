  ...
  methods: {
    ...
    submit() {
      ...
      if (this.siteKey && !this.captchaToken) {
        ...
        this.res = { ok: false, msg: "Invalid CAPTCHA!" };
    ...
    getTurnstileSiteKey() {
      this.$root.getTurnstileSiteKey((res) => {
        if (res.ok) {
          ...
          if (this.siteKey) {
            console.log(
              "Turnstile site key is provided. Loading Turnstile script...",
            );
            ...
            console.warn(
              "Turnstile site key is not provided. Widget will not be rendered.",
            );
          }
        } else {
          console.error(
            "Failed to fetch Turnstile site key from socket:",
            res.msg,
          );
        }
      });
